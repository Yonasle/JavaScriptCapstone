...
listMeals.addEventListener('click', async (e) => {
  if (e.target.classList.contains('likes-icon')) {
    ...
    const messageSuccess = await (0,_modules_renderList__WEBPACK_IMPORTED_MODULE_2__.transferLikes)(mealTitle);
    if (messageSuccess) {
      (0,_modules_renderList__WEBPACK_IMPORTED_MODULE_2__.likesCountUpdate)(likesCountElement, updatedLikes);
    }
  }
});
